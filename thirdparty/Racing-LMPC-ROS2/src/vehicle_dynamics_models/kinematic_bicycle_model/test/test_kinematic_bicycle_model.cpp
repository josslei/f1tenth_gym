...
TEST(KinematicBicycleModelTest, TestKinematicBicycleModel) {
  ...
  const auto share_dir =
      ament_index_cpp::get_package_share_directory("kinematic_bicycle_model");
  ...
  auto config =
      lmpc::vehicle_model::kinematic_bicycle_model::load_parameters(&test_node);
  auto model =
      lmpc::vehicle_model::kinematic_bicycle_model::KinematicBicycleModel(
          base_config, config);
