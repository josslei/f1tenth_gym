...
protected:
  ...
  rclcpp::Publisher<mpclab_msgs::msg::VehicleStateMsg>::SharedPtr
      vehicle_state_pub_;
  ...
  rclcpp::Subscription<mpclab_msgs::msg::VehicleActuationMsg>::SharedPtr
  ...
  // timers
  // step mode: republish vehicle state (TODO(haoru): to be replaced by a
  // service)
