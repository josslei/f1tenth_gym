...
TEST(DoubleTrackPlanarModelTest, TestDoubleTrackPlanarModel) {
  ...
  const auto share_dir =
      ament_index_cpp::get_package_share_directory("double_track_planar_model");
  ...
  auto config = lmpc::vehicle_model::double_track_planar_model::load_parameters(
      &test_node);
  auto model =
      lmpc::vehicle_model::double_track_planar_model::DoubleTrackPlanarModel(
          base_config, config);
