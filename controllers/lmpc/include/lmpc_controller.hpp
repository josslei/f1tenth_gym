...
// Mirrors controllers/controller_base.py's Controller shape (reset/update/control),
// but speaks native casadi::DM end to end -- no array/DM conversion happens inside
// this class. The pybind11 boundary (src/bindings.cpp) is where numpy <-> DM
// conversion happens, once, at the language boundary.
//
...
private:
  ...
  // u_prev -- seeds x_warm/u_warm before the very first solve (DESIGN.md
  // SS8 step 2).
