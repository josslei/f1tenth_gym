...
public:
   ...
   */
  size_t find_closest_waypoint_index(const double &x, const double &y) const;
   ...
   */
  void find_closest_waypoint_indices(const double &x, const double &y,
                                     const size_t &n,
   ...
   */
  void get_waypoint(const size_t &index, double &x, double &y) const;

protected:
  typedef std::unordered_map<WaypointKey, size_t, WaypointKeyHasher>
      WaypointMap;
