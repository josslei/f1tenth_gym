...
def plot_voronoi_fromFile(track_name: str, filename_frictionmap: str) -> None:
    """
    Documentation
    ...
    filepath_frictionmap = os.path.join(
        path2module, "inputs", "frictionmaps", filename_frictionmap
    )
