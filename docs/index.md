...
- `gym/f110_gym/rollout_kernel/README.md`: rollout kernel package overview.
- `planner/tree_search/README.md`: generic tree-search backend notes.
- `planner/f110_self_play/README.md`: F110 self-play orchestration notes.
