...
class FrictionMapInterface:
    ...
    def __init__(self, tpamap_path: str, tpadata_path: str) -> None:
    ...
    def get_friction_singlepos(self, positions: np.ndarray) -> np.ndarray:
        """
...
if __name__ == "__main__":
    ...
    mapint = FrictionMapInterface(tpamap_path=tpamap_path_, tpadata_path=tpadata_path_)
