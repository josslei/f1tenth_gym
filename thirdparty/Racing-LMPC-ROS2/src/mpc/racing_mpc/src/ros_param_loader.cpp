...
RacingMPCConfig::SharedPtr load_parameters(rclcpp::Node *node) {
  ...
  return std::make_shared<RacingMPCConfig>(RacingMPCConfig{
      ...
      casadi::DM::reshape(R, static_cast<casadi_int>(sqrt(R.size1())),
                          static_cast<casadi_int>(sqrt(R.size1()))),
      casadi::DM::reshape(R_d, static_cast<casadi_int>(sqrt(R_d.size1())),
