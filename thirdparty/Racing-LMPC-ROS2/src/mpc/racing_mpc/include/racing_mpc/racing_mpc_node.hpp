...
protected:
  ...
  rclcpp::Publisher<mpclab_msgs::msg::VehicleActuationMsg>::SharedPtr
  ...
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
      ss_vis_pub_{};
  rclcpp::Publisher<lmpc_msgs::msg::MPCTelemetry>::SharedPtr
      mpc_telemetry_pub_{};
  ...
  rclcpp::Subscription<mpclab_msgs::msg::VehicleStateMsg>::SharedPtr
      vehicle_state_sub_{};
  rclcpp::Subscription<lmpc_msgs::msg::TrajectoryCommand>::SharedPtr
  ...
  void on_new_trajectory_command(
      const lmpc_msgs::msg::TrajectoryCommand::SharedPtr msg);
  void on_step_timer();
  rcl_interfaces::msg::SetParametersResult
  on_set_parameters(std::vector<rclcpp::Parameter> const &parameters);
